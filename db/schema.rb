...
ActiveRecord::Schema[8.0].define(version: 2026_02_04_215319) do
  ...
  create_table "tracks", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["file_path"], name: "index_tracks_on_file_path", unique: true
    t.index ["gcs_path"], name: "index_tracks_on_gcs_path", unique: true
    t.index ["last_played_at", "play_count"], name: "idx_scheduler_optimization"
  end
